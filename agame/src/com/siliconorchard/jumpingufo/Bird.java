...
import com.siliconorchard.jumpingufo.Common.FoodType;
...
public class Bird extends CCSprite {
	...
	public static Bird init(int birdType, FoodType setFoodType) {
        ...
        case Common.Bird_Type_bird2:
            ...
            break;
        case Common.Bird_Type_bird3:
        	_bird = new Bird("bird3.png", CGRect.make(0, 0, 55, 55));
            width = 55;
            height = 55;
            _bird.runAction(CCRepeatForever.action((CCIntervalAction) Common.ani_bird3.copy()));
            break;
        default:
            break;
	    }
