...
public class ScoreLayer extends CCLayer {
	...
	private final float GAMECENTER_POS_X   = (440 * Common.kXForIPhone);
	private final float GAMECENTER_POS_Y   = (286 * Common.kYForIPhone);
...
//        gameCenter = CCSprite.sprite("gamecenter.png");
//        gameCenter.setScale(Common.kXForIPhone);
//        gameCenter.setPosition(GAMECENTER_POS_X, GAMECENTER_POS_Y);
//        addChild(gameCenter, 1);
        ...
        for (int i = 0; i < 20; i ++) {
            PlayerInfo playerInfo = (PlayerInfo)Common.gameInfo.get(i);
            ...
            itemNum = CCLabelAtlas.label("0123456789", "num3.png", 16, 21, '0');
            ...
            itemScore = CCLabelAtlas.label("0123456789", "num3.png", 16, 21, '0');
